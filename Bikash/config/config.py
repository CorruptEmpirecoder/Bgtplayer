...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "Miss Aashi")
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Theroomofsecret")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/Theroomofsecret")
...
START_IMG_URL = getenv("START_IMG_URL", "https://telegra.ph/file/088835c9a1e2b2300ed2d.jpg")
PING_IMG_URL = getenv("PING_IMG_URL", "https://telegra.ph/file/088835c9a1e2b2300ed2d.jpg")
...
if PING_IMG_URL:
    if PING_IMG_URL != "resources/Ping.jpeg":
        if not re.match("(?:http|https)://", PING_IMG_URL):
            PING_IMG_URL = "https://telegra.ph/file/088835c9a1e2b2300ed2d.jpg"

if START_IMG_URL:
    if START_IMG_URL != "resources/Ping.jpeg":
        if not re.match("(?:http|https)://", START_IMG_URL):
            START_IMG_URL = "https://telegra.ph/file/088835c9a1e2b2300ed2d.jpg"
